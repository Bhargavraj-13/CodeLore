...
function TopicCard({ topic }) {
  ...
  return (
    <div
      className={`rounded-xl bg-slate-900/60 backdrop-blur-md p-5 transition-all ${cardBorder} ${shadow} hover:scale-[1.01]`}
    >
      ...
      <div className="flex items-center justify-between mt-3">
        ...
        <Link to={`/topics/${topic.contentKey}`} className="text-sm font-medium text-teal-300 hover:text-teal-200">
            Start Learning →
        </Link>
      </div>
    </div>
